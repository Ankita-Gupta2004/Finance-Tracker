...
export default function Footer() {
  ...
  const goToFireSection = (e) => {
    e.preventDefault();
    // navigate to home and ask it to scroll to the id "fireSection"
    navigate("/", { state: { scrollTo: "fireSection" } });
  };
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-3 mt-2">
            {[
              {
                icon: FaLinkedinIn,
                link: "https://www.linkedin.com/in/ankita-gupta-44b251296/",
              },
              {
                icon: FaGithub,
                link: "https://github.com/Ankita-Gupta2004/Finance-Tracker",
              },
              {
                icon: MailCheckIcon,
                link: "mailto:ankitagupta94161@gmail.com",
              },
              {
                icon: FaPinterest,
                link: "https://in.pinterest.com/ankitagupta94161/",
              },
            ].map((item, idx) => (
              <motion.a
                key={idx}
