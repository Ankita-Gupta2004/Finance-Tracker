      ...
      {goals.map((g) => (
        <div key={g.id} className="grid grid-cols-12 gap-3 items-center">
          <input
            ...
            value={g.goal || ""}
            onChange={(e) =>
              handleGoalChange(type, g.id, "goal", e.target.value)
            }
          ...
          <input
            ...
            value={g.timeFrame || ""}
            onChange={(e) =>
              handleGoalChange(type, g.id, "timeFrame", e.target.value)
            }
            className="col-span-3 p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white"
          />
          <input
...
export default function GoalsPage() {
  ...
  const removeGoal = (type, id) => {
    ...
    if (type === "mid")
      setMidTermGoals((prev) => prev.filter((g) => g.id !== id));
    if (type === "long")
  ...
  const handleSaveGoals = () => {
    ...
    alert("Your goals have been saved locally on this device!");
  };
      ...
      <section className="py-16 max-w-6xl mx-auto px-6 lg:px-8 space-y-12">
        ...
        >
          ...
          <p className="text-gray-700 dark:text-gray-300 text-base lg:text-lg max-w-3xl mx-auto leading-relaxed">
            "Set your financial goals systematically to achieve your dreams.
            Plan for short-term, mid-term, and long-term objectives and stay on
            track to achieve them efficiently."
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-gradient-to-b from-white to-gray-100 dark:from-black/10 dark:to-gray-900 p-8 rounded-2xl shadow-xl flex flex-col items-center space-y-6 hover:shadow-2xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-center text-sm leading-relaxed">
              Achievable within 1 year. Examples include Vacation, Gadgets,
              Emergency Fund.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-b from-white to-gray-100 dark:from-black/10 dark:to-gray-900 p-8 rounded-2xl shadow-xl flex flex-col items-center space-y-6 hover:shadow-2xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-center text-sm leading-relaxed">
              Achievable within 1-5 years. Examples include Buying a car, Home
              renovation, Higher studies.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-b from-white to-gray-100 dark:from-black/10 dark:to-gray-900 p-8 rounded-2xl shadow-xl flex flex-col items-center space-y-6 hover:shadow-2xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-center text-sm leading-relaxed">
              Achievable in more than 5 years. Examples include Retirement,
              Buying property, Major investments.
            </p>
          </div>
        </div>
